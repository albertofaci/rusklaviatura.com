...
<html lang="en">
	<head>
		...
		<META name="description" content="Rusklaviatura is a Russian translit that allows you to type in Russian using a standard keyboard. Just type the equivalent English key and Rusklaviatura will transform it into the Russian counterpart. Combination of letters and special marks are supported as well.">
		...
		<script type="text/javascript" src="js/jquery.rusklaviatura.translit.js"></script>
		...
		<form name="formul" ID="Form1">
			<tr>
				<td>
					<div id="tabs">
						<ul>
							<li id="selected" class="translit"><a href="#">Translit</a></li>
							<li class="keyboard"><a href="keyboard">Russian Keyboard</a></li>
...
<scr'+'ipt src="//z-na.amazon-adsystem.com/widgets/onejs?MarketPlace=US"></sc'+'ript>');
					...
					<center>
						<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="hosted_button_id" value="363FT2LWZ6GN2">
